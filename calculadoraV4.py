...
def validar_caracteres(text):
    # Validación: Solo permitir números, operadores y punto decimal
...
entry = tk.Entry(root, textvar=text_var, font="lucida 20 bold", validate="key", validatecommand=(root.register(validar_caracteres), "%S"))
